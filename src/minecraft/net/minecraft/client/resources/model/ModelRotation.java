...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public javax.vecmath.Matrix4f getMatrix4f()
    {
    	javax.vecmath.Matrix4f mat = new javax.vecmath.Matrix4f();
    	mat.m00 = this.matrix4d.m00;
    	mat.m01 = this.matrix4d.m01;
    	mat.m02 = this.matrix4d.m02;
    	mat.m03 = this.matrix4d.m03;
    	mat.m10 = this.matrix4d.m10;
    	mat.m11 = this.matrix4d.m11;
    	mat.m12 = this.matrix4d.m12;
    	mat.m13 = this.matrix4d.m13;
    	mat.m20 = this.matrix4d.m20;
    	mat.m21 = this.matrix4d.m21;
    	mat.m22 = this.matrix4d.m22;
    	mat.m23 = this.matrix4d.m23;
    	mat.m30 = this.matrix4d.m30;
    	mat.m31 = this.matrix4d.m31;
    	mat.m32 = this.matrix4d.m32;
    	mat.m33 = this.matrix4d.m33;
        return mat;
    }
    ...
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (javax.vecmath.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): this.getMatrix4f();
    }
