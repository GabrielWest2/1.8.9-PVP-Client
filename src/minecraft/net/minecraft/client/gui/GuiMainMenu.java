...
import customclient.gui.GuiButtonAnimatedUser;
...
import customclient.gui.GuiScreenLogin;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        int x = sr.getScaledWidth() /2+3;
        this.buttonList.add(new GuiButtonOptions(0, x, y));
        this.buttonList.add(new GuiButtonQuit(4, x+25, y));
        this.buttonList.add(new GuiButtonLanguage(5, x-25, y));
        this.buttonList.add(new GuiButtonCosmetics(19, x-50, y));
    ...
    {
        this.buttonList.add(new GuiButtonTransparent(1, this.width / 2 - 100, p_73969_1_ + 100, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiButtonTransparent(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ + 100, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(new GuiButtonAnimatedUser(9, 10, 10, Main.INSTANCE.currentPlayerHead));

        if (Reflector.GuiModList_Constructor.exists())
        {
            this.buttonList.add(this.modButton = new GuiButtonTransparent(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("fml.menu.mods", new Object[0])));
        }
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if(button.id==9) {
        	Main.INSTANCE.currentPlayerHead = null;
        	mc.session = null;
        	mc.displayGuiScreen(new GuiScreenLogin());
        }
    }
