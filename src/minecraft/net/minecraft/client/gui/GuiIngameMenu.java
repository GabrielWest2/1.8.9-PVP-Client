...
import customclient.gui.list.GuiScreenModList;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(8, this.width / 2 - 100, this.height / 4 + 24 +48 + i, I18n.format("client.name") + " Mods"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 7:
                ...
                break;
            case 8:
            	this.mc.displayGuiScreen(new GuiScreenModList(mc.currentScreen, this.mc.gameSettings));
        }
    }
