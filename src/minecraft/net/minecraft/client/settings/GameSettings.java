...
public class GameSettings
{
    ...
    public KeyBinding keyBindOpenModLayoutMenu = new KeyBinding("key.modLayout", 17, "key.categories.client");
    public KeyBinding keyBindToggleTimeChangerCC = new KeyBinding("key.timeChanger", 17, "key.categories.client");
    public KeyBinding keyPerspectiveModCC = new KeyBinding("key.perspectiveMod", 0, "key.categories.client");
