...
import customclient.mods.MinimalViewBobbingMod;
import customclient.mods.PerspectiveMod;
import customclient.mods.ZoomMod;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private float getFOVModifier(float partialTicks, boolean p_78481_2_)
    {
        ...
        else
        {
            ...
            if (this.mc.currentScreen == null)
            {
                ...
                if(Main.INSTANCE.getMod(ZoomMod.class) != null) {
                	flag = GameSettings.isKeyDown(this.mc.gameSettings.ofKeyBindZoom) && Main.INSTANCE.getMod(ZoomMod.class).isEnabled();
                }
            }
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate(Main.INSTANCE.getMod(PerspectiveMod.class).getYaw() + (Main.INSTANCE.getMod(PerspectiveMod.class).getYaw() - Main.INSTANCE.getMod(PerspectiveMod.class).getYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(Main.INSTANCE.getMod(PerspectiveMod.class).getPitch() + (Main.INSTANCE.getMod(PerspectiveMod.class).getPitch() - Main.INSTANCE.getMod(PerspectiveMod.class).getPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            {
                float f1 = Main.INSTANCE.getMod(PerspectiveMod.class).getYaw();
                float f2 = Main.INSTANCE.getMod(PerspectiveMod.class).getPitch();
                ...
                GlStateManager.rotate(Main.INSTANCE.getMod(PerspectiveMod.class).getPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(Main.INSTANCE.getMod(PerspectiveMod.class).getYaw() - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float)(-d3));
                GlStateManager.rotate(f1 - Main.INSTANCE.getMod(PerspectiveMod.class).getYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - Main.INSTANCE.getMod(PerspectiveMod.class).getPitch(), 1.0F, 0.0F, 0.0F);
            }
        }
        else
        {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                float f6 = Main.INSTANCE.getMod(PerspectiveMod.class).getYaw() + (Main.INSTANCE.getMod(PerspectiveMod.class).getYaw() - Main.INSTANCE.getMod(PerspectiveMod.class).getYaw()) * partialTicks + 180.0F;
                float f7 = Main.INSTANCE.getMod(PerspectiveMod.class).getPitch() + (Main.INSTANCE.getMod(PerspectiveMod.class).getPitch() - Main.INSTANCE.getMod(PerspectiveMod.class).getPitch()) * partialTicks;
                float f8 = 0.0F;
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        {
    		if(Main.INSTANCE.getMod(MinimalViewBobbingMod.class) == null|| (Main.INSTANCE.getMod(MinimalViewBobbingMod.class) != null && !Main.INSTANCE.getMod(MinimalViewBobbingMod.class).isEnabled()))
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (this.mc.inGameHasFocus && flag && Main.INSTANCE.getMod(PerspectiveMod.class).overrideMouse())
        {
