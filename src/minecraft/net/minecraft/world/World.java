...
import customclient.mods.TimeChangerMod;
...
public abstract class World implements IBlockAccess
{
	...
	public float getCelestialAngle(float partialTicks) {
		if(Main.INSTANCE.getMod(TimeChangerMod.class) != null && Main.INSTANCE.getMod(TimeChangerMod.class).isEnabled()) {
			return this.provider.calculateCelestialAngle(Main.INSTANCE.getMod(TimeChangerMod.class).getTime(), partialTicks);
		}else {
