...
import customclient.mods.ParticleMultiplier;
            ...
            if (!targetEntity.hitByEntity(this))
            {
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        ...
                        ParticleMultiplier m = Main.INSTANCE.getMod(ParticleMultiplier.class);
                        if (f1 > 0.0F || (m != null && m.isEnabled() && m.sharpAlways))
                        {
