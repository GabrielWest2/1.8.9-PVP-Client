...
public class KeystrokesModDeserializer implements JsonDeserializer<KeystrokesMod> {

	@Override
	public KeystrokesMod deserialize(JsonElement element, Type t, JsonDeserializationContext context) throws JsonParseException {
		JsonObject obj = element.getAsJsonObject();
		RelativePosition pos = (RelativePosition)ClientFileManager.gson.fromJson(obj.get("position"), RelativePosition.class);
		KeystrokesMod m = new KeystrokesMod();
