...
public class ArmorStatusModDeserializer implements JsonDeserializer<ArmorStatusMod> {

	@Override
	public ArmorStatusMod deserialize(JsonElement element, Type t, JsonDeserializationContext context) throws JsonParseException {
		JsonObject obj = element.getAsJsonObject();
		RelativePosition pos = (RelativePosition)ClientFileManager.gson.fromJson(obj.get("position"), RelativePosition.class);
		ArmorStatusMod m = new ArmorStatusMod();
