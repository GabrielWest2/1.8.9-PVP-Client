...
public class CoordinatesModDeserializer implements JsonDeserializer<CoordinatesMod> {

	@Override
	public CoordinatesMod deserialize(JsonElement element, Type t, JsonDeserializationContext context) throws JsonParseException {
		JsonObject obj = element.getAsJsonObject();
		RelativePosition pos = (RelativePosition)ClientFileManager.gson.fromJson(obj.get("position"), RelativePosition.class);
		CoordinatesMod m = new CoordinatesMod();
