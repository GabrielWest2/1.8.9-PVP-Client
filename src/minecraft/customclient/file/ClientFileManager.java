...
public class ClientFileManager {
	...
	public static void init() {
		...
		gson = new GsonBuilder()
				...
				.registerTypeAdapter(PingMod.class, new PingModDeserializer())
				.registerTypeAdapter(EnchantmentGlintMod.class, new EnchantmentGlintModDeserializer())
				.registerTypeAdapter(PerspectiveMod.class, new PerspectiveModDeserializer())
				.create();
	}
