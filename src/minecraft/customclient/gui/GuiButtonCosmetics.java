...
public class GuiButtonCosmetics extends GuiButton
{

	private ResourceLocation btn = new ResourceLocation("customclient/textures/gui/icon/cosmeticsButton.png");
	private ResourceLocation btnbg = new ResourceLocation("customclient/textures/gui/transparentButtons.png");
    public GuiButtonCosmetics(int buttonID, int xPos, int yPos)
    {
